(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["useDocument"] = factory(require("vue"));
	else
		root["useDocument"] = factory(root["Vue"]);
...
function pausableFilter(extendFilter = shared_bypassFilter) {
  const isActive = (0,external_commonjs_vue_commonjs2_vue_root_Vue_.ref)(true);
  function pause() {
  ...
  return { isActive: (0,external_commonjs_vue_commonjs2_vue_root_Vue_.readonly)(isActive), pause, resume, eventFilter };
}
...
function shared_watchIgnorable(source, cb, options = {}) {
  ...
  if (watchOptions.flush === "sync") {
    const ignore = (0,external_commonjs_vue_commonjs2_vue_root_Vue_.ref)(false);
    ...
    stop = (0,external_commonjs_vue_commonjs2_vue_root_Vue_.watch)(
      source,
      (...args) => {
        if (!ignore.value)
          filteredCb(...args);
    ...
    const disposables = [];
    const ignoreCounter = (0,external_commonjs_vue_commonjs2_vue_root_Vue_.ref)(0);
    const syncCounter = (0,external_commonjs_vue_commonjs2_vue_root_Vue_.ref)(0);
    ignorePrevAsyncUpdates = () => {
...
function useManualRefHistory(source, options = {}) {
  ...
  function _createHistoryRecord() {
    return (0,external_commonjs_vue_commonjs2_vue_root_Vue_.markRaw)({
      snapshot: dump(source.value),
      timestamp: shared_timestamp()
    });
  }
  const last = (0,external_commonjs_vue_commonjs2_vue_root_Vue_.ref)(_createHistoryRecord());
  const undoStack = (0,external_commonjs_vue_commonjs2_vue_root_Vue_.ref)([]);
  const redoStack = (0,external_commonjs_vue_commonjs2_vue_root_Vue_.ref)([]);
  ...
  const history = (0,external_commonjs_vue_commonjs2_vue_root_Vue_.computed)(() => [last.value, ...undoStack.value]);
  const canUndo = (0,external_commonjs_vue_commonjs2_vue_root_Vue_.computed)(() => undoStack.value.length > 0);
  const canRedo = (0,external_commonjs_vue_commonjs2_vue_root_Vue_.computed)(() => redoStack.value.length > 0);
  return {
    source,
    undoStack,
    redoStack,
...
/* harmony default export */ var useDocument = (() => {
  const content = (0,external_commonjs_vue_commonjs2_vue_root_Vue_.ref)([]);
  const {
    canRedo,
    canUndo,
    undo,
...
//# sourceMappingURL=useDocument.umd.js.map