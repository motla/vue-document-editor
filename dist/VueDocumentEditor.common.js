...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  return (0,external_commonjs_vue_commonjs2_vue_root_Vue_namespaceObject.openBlock)(), (0,external_commonjs_vue_commonjs2_vue_root_Vue_namespaceObject.createElementBlock)("div", _hoisted_1, [$props.overlay ? ((0,external_commonjs_vue_commonjs2_vue_root_Vue_namespaceObject.openBlock)(), (0,external_commonjs_vue_commonjs2_vue_root_Vue_namespaceObject.createElementBlock)("div", _hoisted_2, [((0,external_commonjs_vue_commonjs2_vue_root_Vue_namespaceObject.openBlock)(true), (0,external_commonjs_vue_commonjs2_vue_root_Vue_namespaceObject.createElementBlock)(external_commonjs_vue_commonjs2_vue_root_Vue_namespaceObject.Fragment, null, (0,external_commonjs_vue_commonjs2_vue_root_Vue_namespaceObject.renderList)($setup.pages, (page, page_idx) => {
    return (0,external_commonjs_vue_commonjs2_vue_root_Vue_namespaceObject.openBlock)(), (0,external_commonjs_vue_commonjs2_vue_root_Vue_namespaceObject.createElementBlock)("div", {
      ...
      style: (0,external_commonjs_vue_commonjs2_vue_root_Vue_namespaceObject.normalizeStyle)($setup.page_style(page_idx, false))
    }, null, 12, _hoisted_3);
    ...
    style: (0,external_commonjs_vue_commonjs2_vue_root_Vue_namespaceObject.normalizeStyle)($setup.page_style(-1)),
...
/* harmony default export */ var useDocumentEditor = ((props, emit) => {
  ...
  const pages = (0,external_commonjs_vue_commonjs2_vue_root_Vue_namespaceObject.ref)([]);
  // contains page overlays refs indexed by page uuid
  const pages_overlay_refs = (0,external_commonjs_vue_commonjs2_vue_root_Vue_namespaceObject.ref)({});
  // real measured page height in px (corresponding to page_format_mm[1])
  const pages_height = (0,external_commonjs_vue_commonjs2_vue_root_Vue_namespaceObject.ref)(0);
  // real measured page width of an empty editor <div> in px
  const editor_width = (0,external_commonjs_vue_commonjs2_vue_root_Vue_namespaceObject.ref)(0);
  // workaround to avoid infinite update loop
  const prevent_next_content_update_from_parent = (0,external_commonjs_vue_commonjs2_vue_root_Vue_namespaceObject.ref)(false);
  // contains the style at caret position
  const current_text_style = (0,external_commonjs_vue_commonjs2_vue_root_Vue_namespaceObject.ref)(false);
  // flag set when page is rendering in printing mode
  const printing_mode = (0,external_commonjs_vue_commonjs2_vue_root_Vue_namespaceObject.ref)(false);
  const reset_in_progress = (0,external_commonjs_vue_commonjs2_vue_root_Vue_namespaceObject.ref)(false);
  const contentRef = (0,external_commonjs_vue_commonjs2_vue_root_Vue_namespaceObject.ref)();
  const editorRef = (0,external_commonjs_vue_commonjs2_vue_root_Vue_namespaceObject.ref)();
  const css_media_style = (0,external_commonjs_vue_commonjs2_vue_root_Vue_namespaceObject.computed)(() => createStyleElement());
  ...
  (0,external_commonjs_vue_commonjs2_vue_root_Vue_namespaceObject.watch)([() => props.display, () => props.zoom], () => {
    updatePagesELTs();
  });
  return {
    pages,
...
function shared_toRef(...args) {
  if (args.length !== 1)
    return (0,external_commonjs_vue_commonjs2_vue_root_Vue_namespaceObject.toRef)(...args);
  const r = args[0];
  return typeof r === "function" ? (0,external_commonjs_vue_commonjs2_vue_root_Vue_namespaceObject.readonly)((0,external_commonjs_vue_commonjs2_vue_root_Vue_namespaceObject.customRef)(() => ({ get: r, set: shared_noop }))) : (0,external_commonjs_vue_commonjs2_vue_root_Vue_namespaceObject.ref)(r);
}
...
function useMemoize(resolver, options) {
  const initCache = () => {
    if (options == null ? void 0 : options.cache)
      return (0,external_commonjs_vue_commonjs2_vue_root_Vue_namespaceObject.reactive)(options.cache);
    if (vue_demi_lib_isVue2)
      return getMapVue2Compat();
    return (0,external_commonjs_vue_commonjs2_vue_root_Vue_namespaceObject.reactive)(/* @__PURE__ */ new Map());
  };
...
/* harmony default export */ var useKeepFirstPage = (content => {
  const firstContent = (0,external_commonjs_vue_commonjs2_vue_root_Vue_namespaceObject.computed)(() => content.value[0]);
  const isFirstContentString = useMemoize(maybeString => {
    return typeof maybeString === 'string';
  });
  const firstContentTrimmed = (0,external_commonjs_vue_commonjs2_vue_root_Vue_namespaceObject.computed)(() => {
