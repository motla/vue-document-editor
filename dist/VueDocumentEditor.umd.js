...
const _withScopeId = n => (_pushScopeId("data-v-587217e4"), n = n(), _popScopeId(), n);
...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  }, [((0,external_commonjs_vue_commonjs2_vue_root_Vue_.openBlock)(true), (0,external_commonjs_vue_commonjs2_vue_root_Vue_.createElementBlock)(external_commonjs_vue_commonjs2_vue_root_Vue_.Fragment, null, (0,external_commonjs_vue_commonjs2_vue_root_Vue_.renderList)($data.pages, (page, page_idx) => {
    return (0,external_commonjs_vue_commonjs2_vue_root_Vue_.openBlock)(), (0,external_commonjs_vue_commonjs2_vue_root_Vue_.createElementBlock)("div", {
      class: "page",
      key: page.uuid,
      ref_for: true,
      ...
      style: (0,external_commonjs_vue_commonjs2_vue_root_Vue_.normalizeStyle)($options.page_style(page_idx, page.template ? false : true)),
      contenteditable: $props.editable && !page.template ? true : false
    }, [page.template ? ((0,external_commonjs_vue_commonjs2_vue_root_Vue_.openBlock)(), (0,external_commonjs_vue_commonjs2_vue_root_Vue_.createBlock)((0,external_commonjs_vue_commonjs2_vue_root_Vue_.resolveDynamicComponent)(page.template), {
      key: 0,
      modelValue: page.props,
      "onUpdate:modelValue": $event => page.props = $event
    }, null, 8, ["modelValue", "onUpdate:modelValue"])) : (0,external_commonjs_vue_commonjs2_vue_root_Vue_.createCommentVNode)("", true)], 12, _hoisted_5);
  }), 128))], 44, _hoisted_4)], 512);
}
;// CONCATENATED MODULE: ./src/DocumentEditor/DocumentEditor.vue?vue&type=template&id=587217e4&scoped=true
  ...
  methods: {
    ...
    async reset_content() {
      ...
      for (const page of this.pages) {
        const page_elt = this.pages_refs[page.uuid]; // set raw HTML content
    ...
    async fit_content_over_pages() {
      ...
      for (let page_idx = this.pages.length - 1; page_idx >= 0; page_idx--) {
        ...
        const page_elt = this.pages_refs[page.uuid]; // if user deleted the page from the DOM, then remove it from this.pages array
      ...
      for (let page_idx = 0; page_idx < this.pages.length; page_idx++) {
        ...
        let next_page_elt = next_page ? this.pages_refs[next_page.uuid] : null; // check if this page, the next page, or any previous page content has been modified by the user (don't apply to template pages)
...
;// CONCATENATED MODULE: ./src/DocumentEditor/DocumentEditor.vue?vue&type=style&index=0&id=587217e4&lang=css

;// CONCATENATED MODULE: ./node_modules/mini-css-extract-plugin/dist/loader.js??clonedRuleSet-64.use[0]!./node_modules/css-loader/dist/cjs.js??clonedRuleSet-64.use[1]!./node_modules/vue-loader/dist/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-64.use[2]!./node_modules/sass-loader/dist/cjs.js??clonedRuleSet-64.use[3]!./node_modules/vue-loader/dist/index.js??ruleSet[0].use[0]!./src/DocumentEditor/DocumentEditor.vue?vue&type=style&index=1&id=587217e4&lang=scss&scoped=true
// extracted by mini-css-extract-plugin

;// CONCATENATED MODULE: ./src/DocumentEditor/DocumentEditor.vue?vue&type=style&index=1&id=587217e4&lang=scss&scoped=true
...
const __exports__ = /*#__PURE__*/(0,exportHelper/* default */.Z)(DocumentEditorvue_type_script_lang_js, [['render',render],['__scopeId',"data-v-587217e4"]])
