...
function pausableFilter(extendFilter = shared_bypassFilter) {
  const isActive = (0,external_commonjs_vue_commonjs2_vue_root_Vue_namespaceObject.ref)(true);
  function pause() {
  ...
  return { isActive: (0,external_commonjs_vue_commonjs2_vue_root_Vue_namespaceObject.readonly)(isActive), pause, resume, eventFilter };
}
...
function shared_toRef(...args) {
  if (args.length !== 1)
    return toRef$1(...args);
  const r = args[0];
  return typeof r === "function" ? readonly(customRef(() => ({ get: r, set: shared_noop }))) : ref(r);
}
...
function shared_watchIgnorable(source, cb, options = {}) {
  ...
  if (watchOptions.flush === "sync") {
    const ignore = (0,external_commonjs_vue_commonjs2_vue_root_Vue_namespaceObject.ref)(false);
    ...
    stop = (0,external_commonjs_vue_commonjs2_vue_root_Vue_namespaceObject.watch)(
      source,
      (...args) => {
        if (!ignore.value)
          filteredCb(...args);
    ...
    const disposables = [];
    const ignoreCounter = (0,external_commonjs_vue_commonjs2_vue_root_Vue_namespaceObject.ref)(0);
    const syncCounter = (0,external_commonjs_vue_commonjs2_vue_root_Vue_namespaceObject.ref)(0);
    ignorePrevAsyncUpdates = () => {
...
function vue_demi_lib_set(target, key, val) {
  if (Array.isArray(target)) {
    target.length = Math.max(target.length, key)
    target.splice(key, 1, val)
    return val
...
function vue_demi_lib_del(target, key) {
  if (Array.isArray(target)) {
    target.splice(key, 1)
    return
  }
...
function useManualRefHistory(source, options = {}) {
  ...
  function _createHistoryRecord() {
    return (0,external_commonjs_vue_commonjs2_vue_root_Vue_namespaceObject.markRaw)({
      snapshot: dump(source.value),
      timestamp: shared_timestamp()
    });
  }
  const last = (0,external_commonjs_vue_commonjs2_vue_root_Vue_namespaceObject.ref)(_createHistoryRecord());
  const undoStack = (0,external_commonjs_vue_commonjs2_vue_root_Vue_namespaceObject.ref)([]);
  const redoStack = (0,external_commonjs_vue_commonjs2_vue_root_Vue_namespaceObject.ref)([]);
  ...
  const history = (0,external_commonjs_vue_commonjs2_vue_root_Vue_namespaceObject.computed)(() => [last.value, ...undoStack.value]);
  const canUndo = (0,external_commonjs_vue_commonjs2_vue_root_Vue_namespaceObject.computed)(() => undoStack.value.length > 0);
  const canRedo = (0,external_commonjs_vue_commonjs2_vue_root_Vue_namespaceObject.computed)(() => redoStack.value.length > 0);
  return {
    source,
    undoStack,
    redoStack,
...
;// CONCATENATED MODULE: ./src/composables/useDocument.ts


/* harmony default export */ var useDocument = (() => {
  const content = (0,external_commonjs_vue_commonjs2_vue_root_Vue_namespaceObject.ref)([]);
  const {
    canRedo,
    canUndo,
    undo,
...
/* harmony default export */ var entry_lib = (useDocument);


module.exports = __webpack_exports__;
/******/ })()
;
//# sourceMappingURL=useDocument.common.js.map